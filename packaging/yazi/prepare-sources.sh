...
if [[ $# -ne 1 ]]; then
	printf 'usage: %s /path/to/yazi-worktree\n' "$0" >&2
	exit 1
fi
...
spec_path="${script_dir}/yazi.spec"
sources_dir="${script_dir}/SOURCES"
vendor_archive_source="${repo_root}/state/vendor/yazi/yazi-vendor.tar.gz"
vendor_dir="${sources_dir}/vendor"
vendor_config="${sources_dir}/cargo-config.toml"
vendor_archive_target="${sources_dir}/yazi-vendor.tar.gz"
